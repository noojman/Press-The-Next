...
public class NumberTimerBehavior : MonoBehaviour {
	...
	void Start () {
		...
		oldScore = PlayerPrefs.GetFloat ("Numbers High Score", 0);
	...
	public static void SaveScore() {
		PlayerPrefs.SetFloat ("Numbers Current Score", time);
		Debug.Log ("Saved score for numbers game");
		float oldHighscore = PlayerPrefs.GetFloat ("Numbers High Score", 0);
		if (oldHighscore == 0) {
			Debug.Log ("New numbers high score");
			PlayerPrefs.SetFloat ("Numbers High Score", time);
		} else {
